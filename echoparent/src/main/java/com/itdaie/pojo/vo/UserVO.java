...
public class UserVO {
    ...
    /**
     * 收藏歌单数，由collectPlaylistIds数组长度计算得出
     */
    private Integer collectPlaylistCount;
    /**
     * 收藏专辑数，由collectAlbumIds数组长度计算得出
     */
    ...
    /**
     * 收藏单曲数，由collectMusicIds数组长度计算得出
     */
    private Integer collectMusicCount;
